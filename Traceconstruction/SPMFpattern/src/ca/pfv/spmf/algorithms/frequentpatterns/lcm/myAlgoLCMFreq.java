...
import trace.TraceFactory;
	...
	*/
	 ...
	 */
	public class myAlgoLCMFreq {


	    public myAlgoLCMFreq() {
	    ...
	    * and contains the transactions where the items appears. */
	    ...
	    public   Itemsets findFrequentPatternParameterList(Trace trace) throws IOException{

			//	String input = fileToPath("contextPasquier99.txt");
				
				double minsup = 0.7; // means a minsup of 2 transaction (we used a relative support)
				traceDataSet dataset = new traceDataSet(trace,2);
				
				// Applying the algorithm
				myAlgoLCMFreq algo = new myAlgoLCMFreq();
...
//		ItemNameConverter nameConverter;
		//static Trace mytrace=TraceFactory.eINSTANCE.createTrace();



	    public   Itemsets findFrequentPatternObjectstate(Trace trace) throws IOException{

			//	String input = fileToPath("contextPasquier99.txt");
				
				double minsup = 0.05; // means a minsup of 2 transaction (we used a relative support)
				traceDataSet dataset = new traceDataSet(trace,1);
	     ...
	     */
	    public Itemsets runAlgorithm(double minimumSupport, traceDataSet dataset, String outputPath) throws IOException {
...
//			}
	...
	//		MemoryLogger.getInstance().checkMemory();
		 ...
		 * @param dataset
		 */
		public void performFirstOccurenceDelivery(traceDataSet dataset) {
