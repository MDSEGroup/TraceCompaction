...
public class SimultaneousDivergenceAspect extends ConnectionPointAspect {
  ...
  public static boolean isEnabled(final SimultaneousDivergence _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspectSimultaneousDivergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspectSimultaneousDivergenceAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspect._privk3_isEnabled(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence)_self);
    ...
    final org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspectSimultaneousDivergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspectSimultaneousDivergenceAspectContext.getSelf(_self);
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspect._privk3_doFire(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence)_self);
    						}
    					};
