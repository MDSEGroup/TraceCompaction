...
public class HeaderAspect extends IdentifyableElementAspect {
  ...
  public static void initializeModel(final Header _self, final List<String> args) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.HeaderAspectHeaderAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.HeaderAspectHeaderAspectContext.getSelf(_self);
  ...
  public static Iterable<State> getCurrentStates(final Header _self) {
    ...
    return (java.lang.Iterable<org.modelexecution.examples.iml.sequentialiml.iml.State>)result;
  }
