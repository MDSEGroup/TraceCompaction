...
public class ActivityAspect extends IdentifyableElementAspect {
  public static void execute(final Activity _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.ActivityAspectActivityAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.ActivityAspectActivityAspectContext.getSelf(_self);
