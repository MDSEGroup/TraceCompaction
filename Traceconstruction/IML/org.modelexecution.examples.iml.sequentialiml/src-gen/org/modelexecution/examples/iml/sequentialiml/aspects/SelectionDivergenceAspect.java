...
public class SelectionDivergenceAspect extends ConnectionPointAspect {
  ...
  public static boolean isEnabled(final SelectionDivergence _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspectSelectionDivergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspectSelectionDivergenceAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspect._privk3_isEnabled(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence)_self);
    ...
    final org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspectSelectionDivergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspectSelectionDivergenceAspectContext.getSelf(_self);
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspect._privk3_doFire(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence)_self);
    						}
    					};
