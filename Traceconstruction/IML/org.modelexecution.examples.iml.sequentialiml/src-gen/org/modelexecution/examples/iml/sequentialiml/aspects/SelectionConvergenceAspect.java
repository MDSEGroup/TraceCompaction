...
public class SelectionConvergenceAspect extends ConnectionPointAspect {
  ...
  public static boolean isEnabled(final SelectionConvergence _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspectSelectionConvergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspectSelectionConvergenceAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspect._privk3_isEnabled(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence)_self);
    ...
    final org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspectSelectionConvergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspectSelectionConvergenceAspectContext.getSelf(_self);
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspect._privk3_doFire(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence)_self);
    						}
    					};
