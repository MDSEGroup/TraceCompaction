...
public abstract class ConnectionPointAspect {
  ...
  public static boolean isEnabled(final ConnectionPoint _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspectConnectionPointAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspectConnectionPointAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspect.isEnabled((org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspect.isEnabled((org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspect.isEnabled((org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.StateTransition){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspect.isEnabled((org.modelexecution.examples.iml.sequentialiml.iml.StateTransition)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspect.isEnabled((org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspect._privk3_isEnabled(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint)_self);
  ...
  public static void doFire(final ConnectionPoint _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspectConnectionPointAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspectConnectionPointAspectContext.getSelf(_self);
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence){
    					org.modelexecution.examples.iml.sequentialiml.aspects.SelectionDivergenceAspect.doFire((org.modelexecution.examples.iml.sequentialiml.iml.SelectionDivergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence){
    					org.modelexecution.examples.iml.sequentialiml.aspects.SelectionConvergenceAspect.doFire((org.modelexecution.examples.iml.sequentialiml.iml.SelectionConvergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence){
    					org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspect.doFire((org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.StateTransition){
    					org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspect.doFire((org.modelexecution.examples.iml.sequentialiml.iml.StateTransition)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence){
    					org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousDivergenceAspect.doFire((org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousDivergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint){
    					org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspect._privk3_doFire(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint)_self);
    } else  { throw new IllegalArgumentException("Unhandled parameter types: " + java.util.Arrays.<Object>asList(_self).toString()); };
  }
  ...
  public static Iterable<ConnectionPoint> getPredecessors(final ConnectionPoint _self) {
    ...
    return (java.lang.Iterable<org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint>)result;
  }
  ...
  public static ConnectionPoint getSource(final ConnectionPoint _self) {
    ...
    return (org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint)result;
  }
