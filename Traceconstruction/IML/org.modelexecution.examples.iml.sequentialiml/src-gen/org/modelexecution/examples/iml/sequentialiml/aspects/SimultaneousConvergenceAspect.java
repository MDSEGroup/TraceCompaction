...
import org.modelexecution.examples.iml.sequentialiml.aspects.StateAspect;
import org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspect;
...
public class SimultaneousConvergenceAspect extends ConnectionPointAspect {
  ...
  public static boolean isEnabled(final SimultaneousConvergence _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspectSimultaneousConvergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspectSimultaneousConvergenceAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspect._privk3_isEnabled(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence)_self);
    } else  if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspect.isEnabled((org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint)_self);
    ...
    final org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspectSimultaneousConvergenceAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspectSimultaneousConvergenceAspectContext.getSelf(_self);
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							org.modelexecution.examples.iml.sequentialiml.aspects.SimultaneousConvergenceAspect._privk3_doFire(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.SimultaneousConvergence)_self);
    						}
    					};
    					...
    					org.modelexecution.examples.iml.sequentialiml.aspects.ConnectionPointAspect.doFire((org.modelexecution.examples.iml.sequentialiml.iml.ConnectionPoint)_self);
    } else  { throw new IllegalArgumentException("Unhandled parameter types: " + java.util.Arrays.<Object>asList(_self).toString()); };
  }
