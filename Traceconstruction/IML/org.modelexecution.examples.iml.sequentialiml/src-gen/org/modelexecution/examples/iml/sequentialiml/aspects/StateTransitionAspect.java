...
public class StateTransitionAspect extends ConnectionPointAspect {
  ...
  public static boolean isEnabled(final StateTransition _self) {
    final org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspectStateTransitionAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspectStateTransitionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.StateTransition){
    					result = org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspect._privk3_isEnabled(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.StateTransition)_self);
    ...
    final org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspectStateTransitionAspectProperties _self_ = org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspectStateTransitionAspectContext.getSelf(_self);
     if (_self instanceof org.modelexecution.examples.iml.sequentialiml.iml.StateTransition){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							org.modelexecution.examples.iml.sequentialiml.aspects.StateTransitionAspect._privk3_doFire(_self_, (org.modelexecution.examples.iml.sequentialiml.iml.StateTransition)_self);
    						}
    					};
