/**
 */
package org.modelexecution.examples.iml.sequentialiml.iml.impl;
...
import org.modelexecution.examples.iml.sequentialiml.iml.ImlFactory;
import org.modelexecution.examples.iml.sequentialiml.iml.ImlPackage;
...
import org.modelexecution.examples.iml.sequentialiml.iml.Time;
...
public class ImlPackageImpl extends EPackageImpl implements ImlPackage {
	 ...
	 * @see org.modelexecution.examples.iml.sequentialiml.iml.ImlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getConnectionPoint_Firing() {
	...
	public void createPackageContents() {
		...
		createEAttribute(connectionPointEClass, CONNECTION_POINT__FIRING);
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(headerEClass, null, "initializeModel", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(headerEClass, this.getIterable(), "getCurrentStates", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(stateEClass, null, "activate", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(stateEClass, null, "deactivate", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(stateEClass, null, "executeActivities", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(stateTransitionEClass, null, "doFire", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(activityEClass, null, "doExecute", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(simultaneousDivergenceEClass, ecorePackage.getEBoolean(), "isEnabled", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(simultaneousDivergenceEClass, null, "doFire", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(simultaneousConvergenceEClass, ecorePackage.getEBoolean(), "isEnabled", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(simultaneousConvergenceEClass, null, "doFire", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(connectionPointEClass, ecorePackage.getEBoolean(), "isEnabled", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(connectionPointEClass, null, "fire", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(connectionPointEClass, null, "doFire", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(connectionPointEClass, this.getIterable(), "getPredecessors", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(connectionPointEClass, this.getIterable(), "getSuccessors", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(connectionPointEClass, this.getConnectionPoint(), "getSource", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(connectionPointEClass, this.getConnectionPoint(), "getTarget", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (headerEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (headerEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (headerEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (stateTransitionEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (stateTransitionEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (simultaneousDivergenceEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (simultaneousDivergenceEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (simultaneousConvergenceEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (connectionPointEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (connectionPointEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (connectionPointEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (connectionPointEClass.getEOperations().get(3), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (connectionPointEClass.getEOperations().get(4), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (connectionPointEClass.getEOperations().get(5), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (connectionPointEClass.getEOperations().get(6), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (getConnectionPoint_Firing(), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
