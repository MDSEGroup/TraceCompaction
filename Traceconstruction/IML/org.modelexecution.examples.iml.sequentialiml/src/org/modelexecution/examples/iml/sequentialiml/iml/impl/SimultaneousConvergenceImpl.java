 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.SimultaneousConvergenceImpl#isFiring <em>Firing</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimultaneousConvergenceImpl extends IdentifyableElementImpl implements SimultaneousConvergence {
	...
	public void setFiring(boolean newFiring) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImlPackage.SIMULTANEOUS_CONVERGENCE__FIRING, oldFiring, firing));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImlPackage.SIMULTANEOUS_CONVERGENCE__FIRING:
				return isFiring();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ConnectionPoint.class) {
			switch (derivedFeatureID) {
				case ImlPackage.SIMULTANEOUS_CONVERGENCE__FIRING: return ImlPackage.CONNECTION_POINT__FIRING;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ConnectionPoint.class) {
			switch (baseFeatureID) {
				case ImlPackage.CONNECTION_POINT__FIRING: return ImlPackage.SIMULTANEOUS_CONVERGENCE__FIRING;
				default: return -1;
			}
		}
