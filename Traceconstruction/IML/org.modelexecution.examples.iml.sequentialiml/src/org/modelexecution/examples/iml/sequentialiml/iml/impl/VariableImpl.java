 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.VariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.VariableImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.VariableImpl#getSIUnit <em>SI Unit</em>}</li>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.VariableImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.VariableImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.VariableImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends IdentifyableElementImpl implements Variable {
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImlPackage.VARIABLE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ImlPackage.VARIABLE__ADDRESS:
				return getAddress();
			case ImlPackage.VARIABLE__VALUE:
				return getValue();
		}
