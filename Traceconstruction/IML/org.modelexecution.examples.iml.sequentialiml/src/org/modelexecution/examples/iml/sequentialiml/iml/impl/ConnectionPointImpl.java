 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelexecution.examples.iml.sequentialiml.iml.impl.ConnectionPointImpl#isFiring <em>Firing</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConnectionPointImpl extends EObjectImpl implements ConnectionPoint {
	/**
	...
	protected EClass eStaticClass() {
		return ImlPackage.Literals.CONNECTION_POINT;
	}
	...
	public void setFiring(boolean newFiring) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImlPackage.CONNECTION_POINT__FIRING, oldFiring, firing));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImlPackage.CONNECTION_POINT__FIRING:
				return isFiring();
		}
