...
/**
 * This is the item provider adapter for a {@link trace.StepType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StepType_stepName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StepType_stepName_feature", "_UI_StepType_type"),
				 TracePackage.Literals.STEP_TYPE__STEP_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((StepType)object).getStepName();
