...
/**
 * This is the item provider adapter for a {@link trace.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_state_feature", "_UI_Step_type"),
				 TracePackage.Literals.STEP__STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParameterlistPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_parameterlist_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_parameterlist_feature", "_UI_Step_type"),
				 TracePackage.Literals.STEP__PARAMETERLIST,
				 true,
				 false,
				 true,
				 null,
